        ...
        <form class="row g-3" action="insertar.php" method="post">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-select" aria-label="Default select example" name="idUsuario" required>
                    ...
                    <?php
                        include('../../db.php');
                        $consulta= "SELECT * FROM usuario WHERE idRol = 4 and tipo_persona = 'Juridica'  ORDER BY nombre ASC";
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" class="form-control valor"  placeholder="Ingrese el valor total del contrato" aria-label="Default select example" name="valorContrato" required>
            </div>
            <br>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" class="form-control valor"  placeholder="%" aria-label="Default select example" name="anticipo" required>
            </div>
            <div class="form-group col-md-4">
