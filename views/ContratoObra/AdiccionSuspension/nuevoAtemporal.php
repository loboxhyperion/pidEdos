...
<div class="container">
    <div class="" style="text-align:right;padding:5px;">
        ...
        <hr>
        <h1 class="text-center blanco">Corte Atemporal</h1>
        <hr>
    </diV>
    <div class="col-md-12">
        <form class="row g-3" action="insertarAtemporal.php" method="post">

            <div class="form-group col-md-12">
                <label for="fecha_fin_new" class="form-label">Fecha de corte</label>
