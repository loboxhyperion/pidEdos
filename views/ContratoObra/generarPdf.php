...
//Tipo de persona
$pdf->SetFont('Arial','B',6);
$pdf->Cell(28, 5, utf8_decode('Tipo de persona'),1,0,'C',0);
//Responsable de iva 
$pdf->Cell(30, 5, utf8_decode('Resp de iva '),1,0,'C',0);
//Razón social
$pdf->Cell(50, 5, utf8_decode('Razón social'),1,0,'C',0);
//nit
$pdf->Cell(25, 5, utf8_decode('NIT'),1,0,'C',0);
//Telefono
$pdf->Cell(15, 5, utf8_decode('Telefono'),1,0,'C',0);
//Correo
$pdf->Cell(44, 5, utf8_decode('Correo'),1,1,'C',0);
...
//Tipo de persona
$pdf->SetFont('Arial','B',5);
$pdf->Cell(28, 5, utf8_decode($rowContratista['tipo_persona']),1,0,'C',0);
//Responsable de iva
$pdf->Cell(30, 5, utf8_decode($rowContratista['resp_iva']),1,0,'C',0);
//Razón social
$pdf->Cell(50, 5, utf8_decode($rowContratista['razon_social']),1,0,'C',0);
//NIT
$pdf->Cell(25, 5, utf8_decode($rowContratista['nit']),1,0,'C',0);
//Telefono
$pdf->Cell(15, 5, utf8_decode($rowContratista['telefono']),1,0,'C',0);
//Correo
$pdf->Cell(44, 5, utf8_decode($rowContratista['correo']),1,1,'C',0);
...
//Fecha de Necesidad
$pdf->SetFont('Arial','B',6);
$pdf->Cell(28, 5, utf8_decode('Fecha Necesidad'),1,0,'C',0);
//Fecha de Inicio
$pdf->Cell(30, 5, utf8_decode('Fecha de Inicio'),1,0,'C',0);
//Fecha de Fin
$pdf->Cell(30, 5, utf8_decode('Fecha de Fin'),1,0,'C',0);
//Duración
$pdf->Cell(10, 5, utf8_decode('Duración'),1,0,'C',0);
//Valor
$pdf->Cell(38, 5, utf8_decode('Valor'),1,0,'C',0);
//Anticipo
$pdf->Cell(28, 5, utf8_decode('Anticipo'),1,0,'C',0);
//Fecha de Firma 
$pdf->Cell(28, 5, utf8_decode('Fecha de Firma'),1,1,'C',0);
...
$pdf->SetFont('Arial','B',5);
//Fecha de Necesidad
$pdf->Cell(28, 5, utf8_decode($row['fecha_necesidad']),1,0,'C',0);
//Fecha de Inicio
$pdf->Cell(30, 5, utf8_decode($row['fecha_ini']),1,0,'C',0);
//Fecha de Fin
$pdf->Cell(30, 5, utf8_decode($row['fecha_fin']),1,0,'C',0);
//Duración
$pdf->Cell(10, 5, utf8_decode($row['duracion']),1,0,'C',0);
//Valor
$pdf->Cell(38, 5, number_format(intval($row['valor_contrato'])),1,0,'C',0);
//Anticipo
$pdf->Cell(28, 5, utf8_decode($row['anticipo']."%"),1,0,'C',0);
//Fecha de Firma
$pdf->Cell(28, 5, utf8_decode($row['fecha_firma']),1,1,'C',0);
$pdf->Ln(4);
//--//------------------------------------------------------------------//FILA11//------------------------------------------------------------
//--//------------------------------------------------------------------//FILA11//------------------------------------------------------------
//--//------------------------------------------------------------------//FILA11//------------------------------------------------------------
