...
<div class="container">
    ...
    <div class="" style="text-align:right;padding:5px;">
        ...
        ?>
                <a class="btn btn-primary " href="nuevo.php?id=<?php echo $idContrato ?>&nombre=<?php echo $NombreContratistas?>">Agregar Estampilla</a>                         
        <?php
            }
        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex; justify-content:space-between">
                                    ...
                                    ?>
                                            <a class="btn btn-danger btn-sm" href="eliminar.php?idEstampilla=<?php echo $filas2['id'] ?>&id=<?php echo $idContrato ?>&nombre=<?php echo $NombreContratistas?>"><i class="fas fa-trash-alt" style="color:#fff;"></i></a>
                                    <?php
