 ...
 * contrato.duracion, contrato.num_actas, contrato.idUsuario, contrato.idSupervisor FROM usuario JOIN contrato ON usuario.id = contrato.idUsuario WHERE usuario.tipo_persona = "Juridica"
 */
    ...
    if(isset($_POST['keyword']) or isset($_POST['keyword2'])){
        ...
        switch($_SESSION['rol']){
            case 1://admin
                ...
                contrato.valor_contrato,contrato.valorDia,contrato.duracion,contrato.num_actas,contrato.idUsuario,contrato.idSupervisor FROM usuario JOIN contrato ON usuario.id = contrato.idUsuario 
                WHERE contrato.years = $sesionAño AND usuario.tipo_persona = 'Juridica'";
            break;
            case 2://creador
                $consulta= "SELECT usuario.nombre,contrato.id,contrato.num_contrato,contrato.years,contrato.area,contrato.fecha_ini,contrato.fecha_fin,
                contrato.valor_contrato,contrato.valorDia,contrato.duracion,contrato.num_actas,contrato.idUsuario,contrato.idSupervisor FROM usuario JOIN contrato ON usuario.id = contrato.idUsuario 
            ...
            case 3:
                ...
                $consulta= "SELECT usuario.nombre,contrato.id,contrato.num_contrato,contrato.years,contrato.area,contrato.fecha_ini,contrato.fecha_fin,
                contrato.valor_contrato,contrato.valorDia,contrato.duracion,contrato.num_actas,contrato.idUsuario,contrato.idSupervisor FROM usuario JOIN contrato ON usuario.id = contrato.idUsuario 
                WHERE contrato.idSupervisor = $arrayUsuario[id] AND contrato.years = $sesionAño AND usuario.tipo_persona = 'Juridica'"; 
            break;
            case 4:
...
<div class="container">
	...
	?>
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link" href="listar.php">Contratistas</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active" href="listar_empresas.php">Empresas</a>
				</li>
			</ul>
	<?php
		}
    ...
    ?>
            ...
            <br>
            <form action="listar_empresas.php" method="POST" class="form-group col-md-4">
                ...
                <tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a class="btn btn-success btn-sm" href="proyeccion.php?id=<?php echo $filas['id'] ?>&nombre=<?php echo $singleRow['nombre']," ",$singleRow['apellidos'] ?>"><i class="far fa-eye"></i></a></td>
                            ...
                            <td><a class="btn btn-success btn-sm" href="actaInicio.php?id=<?php echo $filas['id'] ?>&nombre=<?php echo $singleRow['nombre']," ",$singleRow['apellidos'] ?>&NombreSupervisor=<?php echo $singleRow2['nombre']," ",$singleRow2['apellidos'] ?>&fechaActa=<?php echo $filas['fecha_ini'] ?>"><i class="far fa-eye"></i></a></td>
                            <td>
                                <?php
                                    //Solo admin y creadores
