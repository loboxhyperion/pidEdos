...
<td width="38%">'.'Directo general'.'</td>
</tr>
...
<tr>
<td width="25%"><strong>Tipo de persona</strong></td>
<td width="20%"><strong>Resp de iva</strong></td>
<td width="15%"><strong>Telefono</strong></td>
<td width="40%"><strong>Correo</strong></td>
</tr>
<tr>
<td width="25%">'.$rowContratista['tipo_persona'].'</td>
<td width="20%">'.$rowContratista['resp_iva'].'</td>
<td width="15%">'.$rowContratista['telefono'].'</td>
<td width="40%">'.$rowContratista['correo'].'</td>
</tr>
...
<tr>
<td width="20%"><strong>Duración</strong></td>
<td width="40%"><strong>Valor</strong></td>
<td width="20%"><strong>Fecha de Inicio</strong></td>
<td width="20%"><strong>Fecha de Fin</strong></td>
</tr>
<tr>
<td width="20%">'.$row['duracion'].'</td>
<td width="40%">'.number_format(intval($row['valor_contrato'])).'</td>
<td width="20%">'.$row['fecha_ini'].'</td>
<td width="20%">'.$row['fecha_fin'].'</td>
</tr>
...
$actividades = "";
// Set some content to print
$actividades  .= '<h2 style="text-align:center">2.Informe de Actividades</h2>
...
$novedad = "";
// Set some content to print
$novedad .= '<h2 style="text-align:center">3.Novedades</h2>
...
$cumplio .= '<div>
                ...
                que ha revisado lo correspondiente a su afiliación al sistema Seguridad Social y ARL y se encuentra al dia durante el mes noviembre de  con dichas obligaciones legales.
