...
if(!isset($_SESSION['rol'])){
     ...
     $result = mysqli_query($conexion,$query) or die("fallo en la conexión contrato");
     ...
     $result3 = mysqli_query($conexion,$query3) or die("fallo en la conexión contratista");
     ...
     $result7 = mysqli_query($conexion,$query7) or die("fallo en la conexión acta ");
     $arrayActa = array();
     ...
     while($filas7=mysqli_fetch_assoc($result7)){
         // echo "<br>".$filas7['fechaPlanilla'];
          //echo "<br>".$filas7['numPlanilla'];
...
<div class="container decorado" style="background: #e0e0e0;border-radius: 25px;">
          ...
          <br>
          <h1 class="text-center blanco">Informe de actividades: <?php echo $NombreContratistas ?></h1>
          <hr>
          <div class="row g-3">
                                   ...
                                   <tr>
                                       ...
                                       <?php  
                                        ...
                                        ?>
                                             ...
                                             <td><input type="number" class="form-control" placeholder="Código" aria-label="Default select example"  required disabled></td>
          ...
          <div class="row">
                    ...
                    <table class="table">
                         <tr>
                              ...
                              <tr>
                                   ...
                                   <td><textarea  class="form-control" aria-label="With textarea"  rows="9" cols="200" readonly><?php echo $filas8['descripcion'] ?></textarea></td>
                                   <td><textarea type="text" class="form-control"  aria-label="Default select example" name="ubicacion[]" rows="12" cols="200" readonly><?php echo $filas8['ubicacion'] ?></textarea></td>
                                   </tr>
                              <?php
                              $cont++;
                              }
               ...
               <div class="form-group col-md-12">
                    ...
                    <textarea  class="form-control" aria-label="With textarea" name="observaciones" rows="5" cols="70" readonly><?php echo $filas9['observaciones']?></textarea>
               </div>
          ...
          <div class="row">
               ...
               <p>El supervisor certifica que cumplió,durante el periodo del <?php echo $filas9['fecha_ini']?> al <?php echo $filas9['fecha_fin']?> a satisfacción el objeto presente contrato,además
                que ha revisado lo correspondiente a su afiliación al sistema Seguridad Social y ARL y se encuentra al dia durante el mes de Febrero con dichas obligaciones legales.
...
<div class="container">
     ...
     <a href="generarPdf.php?id=<?php echo $idContrato  ?>&nombre=<?php echo $NombreContratistas ?>&NombreSupervisor=<?php echo $NombreSupervisor ?>&numInforme=<?php echo $numInforme ?>&fechaInforme=<?php echo $fechaInforme ?>&idActa=<?php echo $idActa ?>" class="btn btn-danger">Generar Pdf</a>
     </div>
</div>
<br>
<br>
