                ...
                <div class="col-md-12">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <input type="hidden" class="form-control" name="num_contrato[]"
                                value="<?php echo $filas['num_contrato'] ?>" />
                            <!---->
                            <td><?php echo $filas['nombre'] . " " . $filas['apellidos'] ?></td>
                            <input type="hidden" class="form-control" name="contratista[]"
                                value="<?php echo $filas['nombre'] . " " . $filas['apellidos'] ?>" />
                            <!---->
                            <td><?php echo number_format($filas['valor_contrato'], 2, ".", ",") ?></td>
                            <input type="hidden" class="form-control" name="valor_contrato[]"
                                value="<?php echo $filas['valor_contrato'] ?>" />
                            <!---->
                            ...
                            <input type="hidden" class="form-control" name="alcances_num[]"
                                value="<?php echo $filas3['alcances_num'] ?>" />
                            <!---->
                            <td><?php echo $filas3['impacto'] ?></td>
                            <input type="hidden" class="form-control" name="alcances_impactados[]"
                                value="<?php echo $filas3['impacto'] ?>" />
                            <!--porcentaje -->
                            ...
                            <input type="hidden" class="form-control" name="seguridad_pagada_avg[]"
                                value="<?php echo isset($filas2['seguridad_pagada_avg']) ? $filas2['seguridad_pagada_avg'] : 0?>" />
                            <!---->
                            <td><?php echo number_format($filas2['seguridad_real_avg'], 2, ".", ",") ?></td>
                            <input type="hidden" class="form-control" name="seguridad_real_avg[]"
                                value="<?php echo isset($filas2['seguridad_real_avg']) ? $filas2['seguridad_real_avg'] : 0?>" />
                            <!---->
                            <td><?php echo number_format(($filas2['seguridad_pagada_avg'] - $filas2['seguridad_real_avg']), 2, ".", ",") ?>
                            </td>
                            <input type="hidden" class="form-control" name="diferencia[]"
                                value="<?php echo $filas2['seguridad_pagada_avg'] - $filas2['seguridad_real_avg'] ?>" />
                            <!---->
                            <td><textarea class="form-control" aria-label="With textarea" name="observaciones[]"
                    ...
                    <br>
                    <input type="hidden" class="form-control" name="idSupervisor"
                        value="<?php echo $varsesion["id"] ?>" />
