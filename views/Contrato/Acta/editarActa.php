    ...
    <form class="row g-3" action="actualizar.php" method="post">
          ...
          <div class="row g-3">
                    <div class="form-group col-md-4">
                              ...
                              <input class="form-control" style="width:50%;" type="date" name="fecha_informe" value="<?php echo $fechaInforme ?>">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                         ...
                         <input type="text" class="form-control" style="width:80%;" value="Prestación de servicios profesionales" readonly>
                    </div>
          </div>
          <hr>
          ...
          <div class="row g-3">
               ...
               <!--------------------------------------------------------------------------->
               <div class="form-group col-md-4">
                    <label class="form-label"><h3>Ordenador del Gasto hasta 21 de agosto del 2024</h3></label>
               ...
               <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control"  value="Directo general" readonly>
                              ...
                              <div class="form-group col-md-4">
                    <label class="form-label"><h3>Ordenador del Gasto desde el 22 de agosto del 2024</h3></label>
                         ...
                         <div class="col-md-12">
                              <table class="table">
                                   ...
                                   ?>
                                        ...
                                        <?php if($cont == 4 || $cont == 6 ){ $baseCotizacionTotal =  $row['valor_contrato'] ;  $baseCotizacion = $row['valorDia'] * 30;   $baseCotizacionDia = $row['valorDia'] ; ?>
                                             <tr>
                                   ...
                                   <tr>
                                        ...
                                        //while($filas7=mysqli_fetch_assoc($result7)){
                                             ...
                                             if($arrayActa[$i] == round($filas5['acomulado'])){
                                                  ...
                                                  if($cont2 == $numInforme){
                                        ?>
                                                       <td><input class="form-control" type="date" name="fechaPlanilla" value="<?php echo $arrayActa[$i+1] ?>"></td>
                                                       <td><input type="text" class="form-control" name="numPlanilla" placeholder="Código" aria-label="Default select example" value="<?php echo $arrayActa[$i+2] ?>" required ></td>
                                                       <td><input type="number" class="form-control"   name="valorPlanilla"placeholder="$ cantidad" aria-label="Default select example" value="<?php echo $arrayActa[$i+3] ?>"></td>
                                                  <?php
                                                  }else{
                                                  ?>
          ...
          <div class="row">
                    ...
                    <table class="table">
                         <tr>
                              ...
                              <tr>
                                   ...
                                   <td><textarea  class="form-control" aria-label="With textarea" name="actividad[]"  rows="9" cols="200" required><?php echo $filas8['descripcion'] ?> </textarea></td>
                                   <td><textarea type="text" class="form-control"  aria-label="Default select example" name="ubicacion[]" rows="12" cols="200"><?php echo $filas8['ubicacion'] ?></textarea></td>
                                   </tr>
                              <?php
                              $cont++;
                              }
               ...
               <div class="form-group col-md-12">
                    ...
                    <textarea  class="form-control" aria-label="With textarea" name="observaciones" rows="5" cols="70"><?php echo $filas9['observaciones']?></textarea>
               </div>
          </div>
          <hr>
