...
<div class="container" style="text-align:right;padding:5px;">
    ...
    <hr>
    <h1 class="text-center blanco">Editar Acta</h1>
    <hr>
</div>
<br>
    ...
    <form class="row g-3" action="actualizar.php" method="post">
        ...
        <div class="row g-3">
            <div class="form-group col-md-4">
                ...
                <input class="form-control" style="width:50%;" type="date" name="fecha_informe"
                    value="<?php echo $fechaInforme ?>">
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" style="width:80%;" value="Prestación de servicios profesionales"
                    readonly>
            </div>
        </div>
        <hr>
        ...
        <div class="row g-3">
            ...
            <div class="form-group col-md-4">
                <label class="form-label">
                    <h3>Ordenador del Gasto hasta 21 de agosto del 2024</h3>
                </label>
            ...
            <div class="form-group col-md-4">
                <label class="form-label">
                    <h3>Ordenador del Gasto desde el 22 de agosto del 2024</h3>
                </label>
                <input type="text" class="form-control" value="SANDRA MILENA FRANCO BERMUDEZ" readonly>
            </div>
            <div class="form-group col-md-4">
                <label class="form-label">
                    <h3>Identificacion</h3>
                </label>
                <input type="text" class="form-control" value="42136044" readonly>
            </div>
            <div class="form-group col-md-4">
                <label class="form-label">
                    <h3>Cargo</h3>
                </label>
                <input type="text" class="form-control" value="Gerente (E)" readonly>
            </div>
            <!--------------------------------------------------------------------------->
            <!--------------------------------SI  ESTA DE VACACIONES EL INFORME SE LLENA CON LA INFORMACION DEL DEL SUPERVISOR ENCARGADO------------------------------------------->
            <div class="form-group col-md-3">
                <label class="form-label">
                    <h3>Supervisor <?php if($rowEncargado["encargado"] == "Si")echo "Encargado"?></h3>
                </label>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control" aria-label="With textarea" name="mas_cotizacion"
                    placeholder="Si no aplica este caso, deje el campo vacío." rows="5"
                    cols="70"><?php echo $filas8['mas_cotizacion']?></textarea>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><?php echo round($filas5['dias'])?></td>
                        ...
                        <?php
                                        ...
                                        //while($filas7=mysqli_fetch_assoc($result7)){
                                             ...
                                             if($arrayActa[$i] == round($filas5['acomulado'])){
                                                  ...
                                                  if($cont2 == $numInforme){
                                        ?>
                        <td><input class="form-control" type="date" name="fechaPlanilla"
                                value="<?php echo $arrayActa[$i+1] ?>"></td>
                        <td><input type="text" class="form-control" name="numPlanilla" placeholder="Código"
                                aria-label="Default select example" value="<?php echo $arrayActa[$i+2] ?>" required>
                        </td>
                        <td><input type="number" class="form-control" name="valorPlanilla" placeholder="$ cantidad"
                                aria-label="Default select example" value="<?php echo $arrayActa[$i+3] ?>"></td>
                        <?php
                                                  }else{
                                                  ?>
        ...
        <div class="row">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><textarea class="form-control" aria-label="With textarea" name="actividad[]" rows="9"
                                cols="200" required><?php echo $filas8['descripcion'] ?> </textarea></td>
                        <td><textarea type="text" class="form-control" aria-label="Default select example"
                                name="ubicacion[]" rows="12" cols="200"><?php echo $filas8['ubicacion'] ?></textarea>
                        </td>
                    </tr>
                    <?php
                              $cont++;
            ...
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control" aria-label="With textarea" name="observaciones" rows="5"
                    cols="70"><?php echo $filas9['observaciones']?></textarea>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="date" value="<?php echo $filas9['fechaPlanilla'] ?>"
                                disabled></td>
                        <td><input type="number" class="form-control" placeholder="Código"
                                aria-label="Default select example" value="<?php echo $filas9['numPlanilla'] ?>"
                                required disabled></td>
                        <td><input type="number" class="form-control" placeholder="$ cantidad"
                                aria-label="Default select example" value="<?php echo $filas9['valorPlanilla'] ?>"
                                disabled></td>
                    </tr>
            ...
            <p>El supervisor certifica que cumplió,durante el periodo del <?php echo $filas9['fecha_ini']?> al
                <?php echo $filas9['fecha_fin']?> a satisfacción el objeto presente contrato,además
        ...
        <input type="hidden" class="form-control" name="idActa" value="<?php echo $idActa ?>" />
        <br>
        <br>
        <br>
