...
$cobertura_desde = $_POST['cobertura_desde'];
$cobertura_hasta = $_POST['cobertura_hasta'];
...
$query = "INSERT INTO contrato (`registro_pptal`, `rubro`, `disp_presupuestal`, `years`, `num_contrato`, `contratante`, `fecha_delegacion`, `num_delegacion`, `area`, `fecha_ini`,
                                ...
                                `fecha_activacion`, `observaciones`, `num_actas`, `idUsuario`, `idSupervisor`, `modalidad`,`fecha_necesidad`,`fecha_firma`,`anticipo`,`idSupervisor2`,
                                `idOrdenador`,`garantia`,`cobertura_desde`,`cobertura_hasta`) VALUES ('$registro_pptal','$rubro','$disp_presupuestal','$years','$num_contrato','$contratante',
                                '$fecha_delegacion','$num_delegacion','$area','$fechaInicio','$fechaFin','$presupuesto','$valorDia','$valorMes','$dias','$objeto','$forma_pago','$entregables',
                                '$salud','$pension','$arl','$dia_habil_pago','$fecha_activacion','$observaciones','$totalActas','$idUsuario','$idSupervisor','$modalidad','$fecha_necesidad',
                                '$fecha_firma','$anticipo','$idSupervisor2','$idOrdenador','$garantia','$cobertura_desde','$cobertura_hasta')";
