                            ...
                            ?>
                                    <td>
                                        <div style="display:flex; justify-content:space-between">
                                            <a class="btn btn-warning btn-sm" href="editar.php?idProyeccion=<?php echo $filas['id'] ?>&id=<?php echo $idContrato ?>&nombre=<?php echo $NombreContratistas?>"><i class="far fa-edit" style="color:#fff;"></i></a>
                                            <a class="btn btn-danger btn-sm" href="eliminar.php?idProyeccion=<?php echo $filas['id'] ?>&id=<?php echo $idContrato ?>&nombre=<?php echo $NombreContratistas?>"><i class="fas fa-trash-alt" style="color:#fff;"></i></a>
                                        </div>
                                    </td>
                            <?php
                                }
